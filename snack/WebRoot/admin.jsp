...
<div  class="content">
		<div class="w840 bpannel accnt mt30">
			<h2 class="tc font20 cg1">管理员登录</h2>
			<h3 id="failregist"style="color: red; text-align: center;;"><s:actionerror/></h3>
            <form class="login-form pr"   action="admin_login"  method="post">
            <div class="accnt-pannel clearfix">
                ...
                <div class="fl left" style="padding:0 305px;">
                    <div class="txt icon-txt">
                        ...
                        <input  type="text"  name="admin.name" id="email" tabindex="1" value=""/>
                    </div>
                    ...
                    <div class="txt icon-txt mt20">
                        ...
                        <input  type="password"  name="admin.password" id="password" value="" tabindex="2"/>
                    </div> 
