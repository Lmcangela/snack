...
<div class="content">
			...
			<div class="new-menu mt20">
                   	<div class="bpannel cb">
                           <a href="snack_info?snackOne.id=<s:property value="#sk.id"/>" title=<s:property value="#sk.name"/>>
                               <div class="v-pw">
                               	<img src=<s:property value="#sk.imgurl"/> width="196" height="126" alt=<s:property value="#sk.name"/>> 
    ...
    <div class="clearfix">
        ...
        <div class="page-num fl">
           ...
           <s:if test="#i.count==pageBean.page">
           <li class="currpage"><a href="#"><s:property value="#i.count"/></a></li>
           </s:if>
           <s:else>
            <li><a target="_self" href="snack_all?page=<s:property value="#i.count"/>"><s:property value="#i.count"/></a></li>
           </s:else>
                     </s:iterator>
          ...
          <div class="page-turn fl">
          <s:if test="pageBean.page!=pageBean.totalPage">
        	<a target="_self" class="next-page" rel="next" href="snack_all?page=<s:property value="pageBean.page+1"/>">下一页►</a>
        	 </s:if>
        	 <s:if test="pageBean.page!=1">
        	<a target="_self" class="next-page" rel="next" href="snack_all?page=<s:property value="pageBean.page-1"/>">上一页◀</a>
        	 </s:if>
			</div>
