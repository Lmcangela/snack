...
<div  class="content">
       ...
       <div class="content-nav mt30 tc font16">
				...
				<a target="_self" href="question_my?id=<s:property value="#session.user.id"/>"
							
					>
						问题</a><span class="cg3">|</span>
       </div>
</div>
...
<div class="pt30 w960 clearfix">
			<div class="fl w632">
				...
				<s:iterator value="snack" var="sk">
					<div class="home-menu">
                    	<div class="bpannel cb">
                            <a href="snack_info?snackOne.id=<s:property value="#sk.id"/>">
                            	<div class="v-pw">
                            ...
                            <p class="readed ml10 mb10 cg2">
                                <span><s:if test="#sk.status==2">审核通过</s:if>
                                	<s:elseif test="#sk.status==1">审核中。。</s:elseif>
                                	<s:else>审核未能通过</s:else>
                                </span>
                                <a onClick="return confirm('确认要删除?')" href="snack_delete?snackOne.id=<s:property value="#sk.id"/>" target="_self"  >删除</a>
                            </p>
                        </div>
                    </div>
					</s:iterator>
