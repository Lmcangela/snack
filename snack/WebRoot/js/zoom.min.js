(function(e) {
    ...
    function a() {
        var t = i.parent("ul").prev();
        if (t.length == 0) {
        	t = e(".gallery ul:last-child");
        }
        t.find("a").trigger("click")
    }
    function f() {
        var t = i.parent("ul").next();
        if (t.length == 0) {
        	t = e(".gallery ul:first-child");
        }
    ...
    o = e(window).height(); (function() {
        ...
        if (e(".gallery ul a").length == 1) e(".gallery ul a")[0].addClass("zoom");
        e(".zoom, .gallery ul a").on("click", u)
    })(); (function() {
