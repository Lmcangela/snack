								...
								<tr
									...
									<s:iterator var="p" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
												<s:property value="#p.password"/>
											</td>
											
											<td align="center" style="HEIGHT: 22px">
												<a target="_self" href="user_edit?id=<s:property value="#p.id"/>">
													<img src="images/edit.png" border="0" style="CURSOR: hand;width:15px;height:15px;">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a target="_self" onClick="return confirm('确认要删除?')" href="user_delete?id=<s:property value="#p.id"/>">
					...
					<tr align="center">
						<td colspan="7">
							...
							<s:if test="pageBean.page != 1">
								<a target="_self" href="user_list?page=1">首页</a>|
								<a target="_self" href="user_list?page=<s:property value="pageBean.page-1"/>">上一页</a>|
							</s:if>
							<s:if test="pageBean.page != pageBean.totalPage">
								<a target="_self" href="user_list?page=<s:property value="pageBean.page+1"/>">下一页</a>|
								<a target="_self" href="user_list?page=<s:property value="pageBean.totalPage"/>">尾页</a>|
							</s:if>
						</td>
					</tr>
				</TBODY>
