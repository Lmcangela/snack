...
<div class="pt30 w960 clearfix">
			<div class="fl w632">
				...
				<s:iterator value="collecList" var="coll">
					<div class="home-menu">
                    	<div class="bpannel cb">
                            <a href="snack_info?snackOne.id=<s:property value="#coll.snack.id"/>">
                            	<div class="v-pw">
                            	<img src=<s:property value="#coll.snack.imgurl"/> width="196" height="126"> 
                                    <div class="v-pw-w mt10 ml10">
                                         <s:property value="#coll.snack.name"/></div>
                                </div>
                            </a>
                            <p class="readed ml10 mb10 cg2">
                                <span>小吃编号：<s:property value="#coll.snack.id"/></span>
                            </p>
                        </div>
                    </div>
					</s:iterator>
